                ...
                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                    <div class="login_logo login_border_radius1">
                        <h3 class="text-xs-center">
                            <img src="{{ asset('administrator/img/logow.png') }}" alt="josh logo" class="admire_logo"><span class="text-white"> USERS &nbsp;<br/>
                                Reset Password</span>
                        </h3>
                    </div>
                    ...
                    <form action="{{ route('user.password.request') }}" name="login_form" id="login_form" method="post" class="login_form">
